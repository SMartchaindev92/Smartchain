...
// all blocks' seal as valid, though they still have to conform to the Gquantumchain
// consensus rules.
...
// still have to conform to the Gquantumchain consensus rules.
...
// they still have to conform to the Gquantumchain consensus rules.
...
func (Ethash *Ethash) APIs(chain consensus.ChainHeaderReader) []rpc.API {
	...
	// to both gwc and Ethash namespaces.
	return []rpc.API{
		{
			Namespace: "eth",
			Version:   "1.0",
