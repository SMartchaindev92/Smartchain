...
// mapped from textual names used in the tests below to actual Gquantumchain private
...
// address retrieves the Gquantumchain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Gquantumchain address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/SMartchaindev92/Smartchain/issues/17593). Whilst this
