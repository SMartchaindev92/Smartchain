...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gwc.ipc", false, filepath.Join(os.TempDir(), "gwc.ipc")},
		{"data", "gwc.ipc", false, "data/gwc.ipc"},
		{"data", "./gwc.ipc", false, "./gwc.ipc"},
		{"data", "/gwc.ipc", false, "/gwc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gwc.ipc", true, `\\.\pipe\gwc.ipc`},
		{"data", "gwc.ipc", true, `\\.\pipe\gwc.ipc`},
		{"data", `\\.\pipe\gwc.ipc`, true, `\\.\pipe\gwc.ipc`},
	}
