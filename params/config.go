...
var (
	MainnetGenesisHash = common.HexToHash("0x65cbbcb40f3862f4d56e4c91f4b523c55fce49bde7a2f23680c980016e2e4402")
...
var (
	...
	MainnetTrustedCheckpoint = &TrustedCheckpoint{
		SectionIndex: 413,
		SectionHead:  common.HexToHash("0x"),
		CHTRoot:      common.HexToHash("0x"),
		BloomRoot:    common.HexToHash("0x"),
	}
	...
	// and accepted by the Gquantumchain core developers into the Ethash consensus.
	//
	...
	// and accepted by the Gquantumchain core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
// CheckConfigForkOrder checks that we don't "skip" any forks, gwc isn't pluggable enough
