...
import (
	...
	"github.com/SMartchaindev92/Smartchain/signer/core"
	"github.com/SMartchaindev92/Smartchain/signer/core/apitypes"
	"github.com/SMartchaindev92/Smartchain/signer/fourbyte"
	"github.com/SMartchaindev92/Smartchain/signer/rules"
	"github.com/SMartchaindev92/Smartchain/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Gquantumchain account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func checkFile(filename string) error {
	...
	// https://github.com/SMartchaindev92/Smartchain/issues/20123
