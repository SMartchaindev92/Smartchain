...
This setup allows a DApp to connect to a remote Gquantumchain node and send transactions that are locally signed. This can help in situations when a DApp is connected to an untrusted remote Gquantumchain node, because a local one is not available, not synchronised with the chain, or is a node that has no built-in (or limited) account management.
...
GLOBAL OPTIONS:
   ...
   --keystore value        Directory for the keystore (default: "$HOME/.gwc/keystore")
...
In this case, `gwc` would be started with `--signer http://localhost:8550` and would relay requests to `gwc.sendTransaction`.
...
* Geth todos
    ...
    - Relay: Geth should be started in `gwc --signer localhost:8550`.
  ...
  "params": [
    {
      "accounts": [
        {
          "url": "keystore:///home/bazonk/.gwc/keystore/UTC--2017-11-20T14-44-54.089682944Z--123409812340981234098123409812deadbeef42",
          "address": "0x123409812340981234098123409812deadbeef42"
        },
        {
          "url": "keystore:///home/bazonk/.gwc/keystore/UTC--2017-11-23T21-59-03.199240693Z--cafebabedeadbeef34098123409812deadbeef42",
