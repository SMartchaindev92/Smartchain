		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
gwc snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
gwc snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
gwc snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
gwc snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gwc dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gwc dump', but uses the snapshots
