...
import (
	...
	"github.com/SMartchaindev92/Smartchain/common/compiler"
...
var (
	...
	abiFlag = cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the Gquantumchain contract ABI json to bind, - for STDIN",
	}
	binFlag = cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the Gquantumchain contract bytecode (generate deploy method)",
	}
	...
	solFlag = cli.StringFlag{
		Name:  "sol",
		Usage: "Path to the Gquantumchain contract Solidity source to build and bind",
	}
	...
	vyFlag = cli.StringFlag{
		Name:  "vy",
		Usage: "Path to the Gquantumchain contract Vyper source to build and bind",
	}
