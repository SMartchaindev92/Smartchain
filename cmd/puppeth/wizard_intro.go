...
// setting up a new or managing an existing Gquantumchain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Gquantumchain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Gquantumchain network down to  |")
	...
	log.Info("Administering Gquantumchain network", "name", w.network)
