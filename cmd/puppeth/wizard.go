...
type wizard struct {
	...
	services map[string][]string   // Gquantumchain services known to be running on servers
...
// it to an Gquantumchain address.
...
// converts it to an Gquantumchain address. If an empty line is entered, the default
// value is returned.
