...
# 1. install gwc for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gwc
# 5. create gwc, attach and uninstall start menu entries
...
!define GROUPNAME "Gquantumchain"
!define APPNAME "Geth"
!define DESCRIPTION "Official Go implementation of the Gquantumchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gwc is installed global
