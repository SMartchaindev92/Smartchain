Name "gwc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/SMartchaindev92/Smartchain/issues"
!define UPDATEURL "https://github.com/SMartchaindev92/Smartchain/releases"
!define ABOUTURL "https://github.com/SMartchaindev92/Smartchain#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gwc.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gwc.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:30304)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:30304)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:30304)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30304)" ""  6 1 1 2147483647 1 "$INSTDIR\gwc.exe" "" "" "Gquantumchain" 30304 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30304)" ""  6 2 1 2147483647 1 "$INSTDIR\gwc.exe" "" "" "Gquantumchain" "" 30304 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30304)" "" 17 2 1 2147483647 1 "$INSTDIR\gwc.exe" "" "" "Gquantumchain" "" 30304 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gwc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gwc.ipc"
