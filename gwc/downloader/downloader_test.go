...
import (
	...
	"github.com/SMartchaindev92/Smartchain"
	"github.com/SMartchaindev92/Smartchain/common"
	"github.com/SMartchaindev92/Smartchain/core/rawdb"
	"github.com/SMartchaindev92/Smartchain/core/state/snapshot"
	"github.com/SMartchaindev92/Smartchain/core/types"
	"github.com/SMartchaindev92/Smartchain/eth/protocols/eth"
	"github.com/SMartchaindev92/Smartchain/ethdb"
	"github.com/SMartchaindev92/Smartchain/event"
	"github.com/SMartchaindev92/Smartchain/trie"
)
...
func TestCanonicalSynchronisation66Full(t *testing.T)  { testCanonSync(t, gwc.ETH66, FullSync) }
func TestCanonicalSynchronisation66Fast(t *testing.T)  { testCanonSync(t, gwc.ETH66, FastSync) }
func TestCanonicalSynchronisation66Light(t *testing.T) { testCanonSync(t, gwc.ETH66, LightSync) }
...
func TestThrottling66Full(t *testing.T) { testThrottling(t, gwc.ETH66, FullSync) }
func TestThrottling66Fast(t *testing.T) { testThrottling(t, gwc.ETH66, FastSync) }
...
func TestForkedSync66Full(t *testing.T)  { testForkedSync(t, gwc.ETH66, FullSync) }
func TestForkedSync66Fast(t *testing.T)  { testForkedSync(t, gwc.ETH66, FastSync) }
func TestForkedSync66Light(t *testing.T) { testForkedSync(t, gwc.ETH66, LightSync) }
...
func TestHeavyForkedSync66Full(t *testing.T)  { testHeavyForkedSync(t, gwc.ETH66, FullSync) }
func TestHeavyForkedSync66Fast(t *testing.T)  { testHeavyForkedSync(t, gwc.ETH66, FastSync) }
func TestHeavyForkedSync66Light(t *testing.T) { testHeavyForkedSync(t, gwc.ETH66, LightSync) }
...
// long dead chains.
func TestBoundedForkedSync66Full(t *testing.T)  { testBoundedForkedSync(t, gwc.ETH66, FullSync) }
func TestBoundedForkedSync66Fast(t *testing.T)  { testBoundedForkedSync(t, gwc.ETH66, FastSync) }
func TestBoundedForkedSync66Light(t *testing.T) { testBoundedForkedSync(t, gwc.ETH66, LightSync) }
...
func TestBoundedHeavyForkedSync66Full(t *testing.T) {
	testBoundedHeavyForkedSync(t, gwc.ETH66, FullSync)
}
func TestBoundedHeavyForkedSync66Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, gwc.ETH66, FastSync)
}
func TestBoundedHeavyForkedSync66Light(t *testing.T) {
	testBoundedHeavyForkedSync(t, gwc.ETH66, LightSync)
}
...
func TestCancel66Full(t *testing.T)  { testCancel(t, gwc.ETH66, FullSync) }
func TestCancel66Fast(t *testing.T)  { testCancel(t, gwc.ETH66, FastSync) }
func TestCancel66Light(t *testing.T) { testCancel(t, gwc.ETH66, LightSync) }
...
func TestMultiSynchronisation66Full(t *testing.T)  { testMultiSynchronisation(t, gwc.ETH66, FullSync) }
func TestMultiSynchronisation66Fast(t *testing.T)  { testMultiSynchronisation(t, gwc.ETH66, FastSync) }
func TestMultiSynchronisation66Light(t *testing.T) { testMultiSynchronisation(t, gwc.ETH66, LightSync) }
...
func TestMultiProtoSynchronisation66Full(t *testing.T)  { testMultiProtoSync(t, gwc.ETH66, FullSync) }
func TestMultiProtoSynchronisation66Fast(t *testing.T)  { testMultiProtoSync(t, gwc.ETH66, FastSync) }
func TestMultiProtoSynchronisation66Light(t *testing.T) { testMultiProtoSync(t, gwc.ETH66, LightSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 66", gwc.ETH66, chain)
	//tester.newPeer("peer 65", gwc.ETH67, chain)
...
func TestEmptyShortCircuit66Full(t *testing.T)  { testEmptyShortCircuit(t, gwc.ETH66, FullSync) }
func TestEmptyShortCircuit66Fast(t *testing.T)  { testEmptyShortCircuit(t, gwc.ETH66, FastSync) }
func TestEmptyShortCircuit66Light(t *testing.T) { testEmptyShortCircuit(t, gwc.ETH66, LightSync) }
...
func TestMissingHeaderAttack66Full(t *testing.T)  { testMissingHeaderAttack(t, gwc.ETH66, FullSync) }
func TestMissingHeaderAttack66Fast(t *testing.T)  { testMissingHeaderAttack(t, gwc.ETH66, FastSync) }
func TestMissingHeaderAttack66Light(t *testing.T) { testMissingHeaderAttack(t, gwc.ETH66, LightSync) }
...
func TestShiftedHeaderAttack66Full(t *testing.T)  { testShiftedHeaderAttack(t, gwc.ETH66, FullSync) }
func TestShiftedHeaderAttack66Fast(t *testing.T)  { testShiftedHeaderAttack(t, gwc.ETH66, FastSync) }
func TestShiftedHeaderAttack66Light(t *testing.T) { testShiftedHeaderAttack(t, gwc.ETH66, LightSync) }
...
func TestInvalidHeaderRollback66Fast(t *testing.T) { testInvalidHeaderRollback(t, gwc.ETH66, FastSync) }
...
func TestHighTDStarvationAttack66Full(t *testing.T) {
	testHighTDStarvationAttack(t, gwc.ETH66, FullSync)
}
func TestHighTDStarvationAttack66Fast(t *testing.T) {
	testHighTDStarvationAttack(t, gwc.ETH66, FastSync)
}
func TestHighTDStarvationAttack66Light(t *testing.T) {
	testHighTDStarvationAttack(t, gwc.ETH66, LightSync)
}
...
func TestBlockHeaderAttackerDropping66(t *testing.T) { testBlockHeaderAttackerDropping(t, gwc.ETH66) }
...
func TestSyncProgress66Full(t *testing.T)  { testSyncProgress(t, gwc.ETH66, FullSync) }
func TestSyncProgress66Fast(t *testing.T)  { testSyncProgress(t, gwc.ETH66, FastSync) }
func TestSyncProgress66Light(t *testing.T) { testSyncProgress(t, gwc.ETH66, LightSync) }
...
// revertal).
func TestForkedSyncProgress66Full(t *testing.T)  { testForkedSyncProgress(t, gwc.ETH66, FullSync) }
func TestForkedSyncProgress66Fast(t *testing.T)  { testForkedSyncProgress(t, gwc.ETH66, FastSync) }
func TestForkedSyncProgress66Light(t *testing.T) { testForkedSyncProgress(t, gwc.ETH66, LightSync) }
...
func TestFailedSyncProgress66Full(t *testing.T)  { testFailedSyncProgress(t, gwc.ETH66, FullSync) }
func TestFailedSyncProgress66Fast(t *testing.T)  { testFailedSyncProgress(t, gwc.ETH66, FastSync) }
func TestFailedSyncProgress66Light(t *testing.T) { testFailedSyncProgress(t, gwc.ETH66, LightSync) }
...
func TestFakedSyncProgress66Full(t *testing.T)  { testFakedSyncProgress(t, gwc.ETH66, FullSync) }
func TestFakedSyncProgress66Fast(t *testing.T)  { testFakedSyncProgress(t, gwc.ETH66, FastSync) }
func TestFakedSyncProgress66Light(t *testing.T) { testFakedSyncProgress(t, gwc.ETH66, LightSync) }
...
func TestDeliverHeadersHang66Full(t *testing.T)  { testDeliverHeadersHang(t, gwc.ETH66, FullSync) }
func TestDeliverHeadersHang66Fast(t *testing.T)  { testDeliverHeadersHang(t, gwc.ETH66, FastSync) }
func TestDeliverHeadersHang66Light(t *testing.T) { testDeliverHeadersHang(t, gwc.ETH66, LightSync) }
...
func TestCheckpointEnforcement66Full(t *testing.T) { testCheckpointEnforcement(t, gwc.ETH66, FullSync) }
func TestCheckpointEnforcement66Fast(t *testing.T) { testCheckpointEnforcement(t, gwc.ETH66, FastSync) }
func TestCheckpointEnforcement66Light(t *testing.T) {
	testCheckpointEnforcement(t, gwc.ETH66, LightSync)
}
