...
var (
	...
	// testAddr is the Gquantumchain address of the tester account.
	testAddr = crypto.PubkeyToAddress(testKey.PublicKey)
)

// testBackend is a mock implementation of the live Gquantumchain message handler. Its
// purpose is to allow testing the request/reply workflows and wire serialization
// in the `gwc` protocol without actually doing any data processing.
