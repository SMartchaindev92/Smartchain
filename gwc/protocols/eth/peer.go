...
// Peer is a collection of relevant information we have about a `gwc` peer.
type Peer struct {
...
// Version retrieves the peer's negoatiated `gwc` protocol version.
...
// ReplyPooledTransactionsRLP is the gwc/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeaders is the gwc/66 version of SendBlockHeaders.
...
// ReplyBlockBodiesRLP is the gwc/66 version of SendBlockBodiesRLP.
...
// ReplyNodeData is the gwc/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the gwc/66 response to GetReceipts.
