...
// Syncer is an Gquantumchain account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Gquantumchain state over the
// snap protocol.
