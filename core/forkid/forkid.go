...
// NewID calculates the Gquantumchain fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Gquantumchain fork ID from an existing chain instance.
