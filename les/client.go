...
// Package les implements the Light Gquantumchain Subprotocol.
package les
...
import (
	...
	"github.com/SMartchaindev92/Smartchain/les/downloader"
	"github.com/SMartchaindev92/Smartchain/les/vflux"
	vfc "github.com/SMartchaindev92/Smartchain/les/vflux/client"
	...
	"github.com/SMartchaindev92/Smartchain/p2p/enr"
...
func New(stack *node.Node, config *ethconfig.Config) (*LightEthereum, error) {
	chainDb, err := stack.OpenDatabase("lightchaindata", config.DatabaseCache, config.DatabaseHandles, "gwc/db/chaindata/", false)
	if err != nil {
		return nil, err
	}
	lesDb, err := stack.OpenDatabase("les.client", 0, 0, "gwc/db/lesclient/", false)
	if err != nil {
		return nil, err
	}
