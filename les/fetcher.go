...
import (
	...
	"github.com/SMartchaindev92/Smartchain/les/fetcher"
...
// the gwc.BlockFetcher as the underlying fetcher but adding more additional
...
//
// Note, we rely on the underlying gwc/fetcher to retrieve and validate the
// response, so that we have to obey the rule of gwc/fetcher which only accepts
