...
import (
	...
	ethdownloader "github.com/SMartchaindev92/Smartchain/gwc/downloader"
	...
	"github.com/SMartchaindev92/Smartchain/p2p/simulations"
	"github.com/SMartchaindev92/Smartchain/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	ethereum, err := gwc.New(stack, &config)
	if err != nil {
		return nil, err
	}
