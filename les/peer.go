...
import (
	...
	"github.com/SMartchaindev92/Smartchain/les/utils"
...
// PeerInfo represents a short summary of the `gwc` sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Gquantumchain protocol version negotiated
...
// participating in the Light Gquantumchain sub-protocol.
...
// for us(server) but for other protocols(e.g. GQC) upon the devp2p they
// may be useful.
