...
// most of Gquantumchain's existence, so might as well go with it.
...
// An Gquantumchain node doesn't need hundreds of connections to operate correctly,
...
type Tracker struct {
	...
	// (eg. gwc.getHeaders vs snap.getAccountRange).
