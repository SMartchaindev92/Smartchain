...
import (
	...
	"github.com/SMartchaindev92/Smartchain/common/mclock"
	"github.com/SMartchaindev92/Smartchain/internal/testlog"
	...
	runDialTest(t, config, []dialTestRound{
		...
		// 9 nodes are discovered, but only 2 are dialed.
		{
			...
			discovered: []*enode.Node{
				newNode(uintID(0x00), "127.0.0.1:30304"), // not dialed because already connected as static peer
				newNode(uintID(0x02), "127.0.0.1:30304"), // ...
				newNode(uintID(0x03), "127.0.0.1:30304"),
				newNode(uintID(0x04), "127.0.0.1:30304"),
				newNode(uintID(0x05), "127.0.0.1:30304"), // not dialed because there are only two slots
				newNode(uintID(0x06), "127.0.0.1:30304"), // ...
				newNode(uintID(0x07), "127.0.0.1:30304"), // ...
				newNode(uintID(0x08), "127.0.0.1:30304"), // ...
			},
		...
		// One dial completes, freeing one dial slot.
		{
			...
			wantNewDials: []*enode.Node{
				newNode(uintID(0x05), "127.0.0.1:30304"),
			},
		},
		...
		// Dial to 0x03 completes, filling the last remaining peer slot.
		{
			...
			discovered: []*enode.Node{
				newNode(uintID(0x09), "127.0.0.1:30304"), // not dialed because there are no free slots
			},
		},
		...
		// (i.e. up to maxActiveDialTasks) are used.
		{
			...
			discovered: []*enode.Node{
				newNode(uintID(0x0a), "127.0.0.1:30304"),
				newNode(uintID(0x0b), "127.0.0.1:30304"),
				newNode(uintID(0x0c), "127.0.0.1:30304"),
				newNode(uintID(0x0d), "127.0.0.1:30304"),
				newNode(uintID(0x0f), "127.0.0.1:30304"),
			},
			wantNewDials: []*enode.Node{
				newNode(uintID(0x06), "127.0.0.1:30304"),
				newNode(uintID(0x07), "127.0.0.1:30304"),
				newNode(uintID(0x08), "127.0.0.1:30304"),
				newNode(uintID(0x09), "127.0.0.1:30304"),
				newNode(uintID(0x0a), "127.0.0.1:30304"),
			},
		},
	})
...
func TestDialSchedNetRestrict(t *testing.T) {
	...
	nodes := []*enode.Node{
		newNode(uintID(0x01), "127.0.0.1:30304"),
		newNode(uintID(0x02), "127.0.0.2:30304"),
		newNode(uintID(0x03), "127.0.0.3:30304"),
		newNode(uintID(0x04), "127.0.0.4:30304"),
		newNode(uintID(0x05), "127.0.2.5:30304"),
		newNode(uintID(0x06), "127.0.2.6:30304"),
		newNode(uintID(0x07), "127.0.2.7:30304"),
		newNode(uintID(0x08), "127.0.2.8:30304"),
	}
	config := dialConfig{
...
func TestDialSchedStaticDial(t *testing.T) {
	...
	runDialTest(t, config, []dialTestRound{
		...
		{
			peersAdded: []*conn{
				{flags: dynDialedConn, node: newNode(uintID(0x01), "127.0.0.1:30304")},
				{flags: dynDialedConn, node: newNode(uintID(0x02), "127.0.0.2:30304")},
			},
			update: func(d *dialScheduler) {
				// These two are not dialed because they're already connected
				// as dynamic peers.
				d.addStatic(newNode(uintID(0x01), "127.0.0.1:30304"))
				d.addStatic(newNode(uintID(0x02), "127.0.0.2:30304"))
				// These nodes will be dialed:
				d.addStatic(newNode(uintID(0x03), "127.0.0.3:30304"))
				d.addStatic(newNode(uintID(0x04), "127.0.0.4:30304"))
				d.addStatic(newNode(uintID(0x05), "127.0.0.5:30304"))
				d.addStatic(newNode(uintID(0x06), "127.0.0.6:30304"))
				d.addStatic(newNode(uintID(0x07), "127.0.0.7:30304"))
				d.addStatic(newNode(uintID(0x08), "127.0.0.8:30304"))
				d.addStatic(newNode(uintID(0x09), "127.0.0.9:30304"))
			},
			wantNewDials: []*enode.Node{
				newNode(uintID(0x03), "127.0.0.3:30304"),
				newNode(uintID(0x04), "127.0.0.4:30304"),
				newNode(uintID(0x05), "127.0.0.5:30304"),
				newNode(uintID(0x06), "127.0.0.6:30304"),
			},
		},
		...
		// two dials are launched to attempt to fill it.
		{
			...
			wantNewDials: []*enode.Node{
				newNode(uintID(0x08), "127.0.0.8:30304"),
				newNode(uintID(0x09), "127.0.0.9:30304"),
			},
		},
		...
		{
			peersAdded: []*conn{
				{flags: inboundConn, node: newNode(uintID(0x07), "127.0.0.7:30304")},
			},
			peersRemoved: []enode.ID{
				uintID(0x01),
			},
...
func TestDialSchedRemoveStatic(t *testing.T) {
	...
	runDialTest(t, config, []dialTestRound{
		...
		{
			update: func(d *dialScheduler) {
				d.removeStatic(newNode(uintID(0x01), "127.0.0.1:30304"))
				d.removeStatic(newNode(uintID(0x02), "127.0.0.2:30304"))
				d.removeStatic(newNode(uintID(0x03), "127.0.0.3:30304"))
			},
			failed: []enode.ID{
				uintID(0x02),
			},
	...
	runDialTest(t, config, []dialTestRound{
		{
			...
			update: func(d *dialScheduler) {
				for id := uint16(0); id < 2000; id++ {
					n := newNode(uintID(id), "127.0.0.1:30304")
					d.addStatic(n)
				}
			},
		},
		{
			...
			wantNewDials: []*enode.Node{
				newNode(uintID(0x0085), "127.0.0.1:30304"),
				newNode(uintID(0x02dc), "127.0.0.1:30304"),
				newNode(uintID(0x0285), "127.0.0.1:30304"),
				newNode(uintID(0x00cb), "127.0.0.1:30304"),
			},
		},
	})
}
...
func TestDialSchedResolve(t *testing.T) {
	...
	resolved := newNode(uintID(0x01), "127.0.0.1:30304")
	resolved2 := newNode(uintID(0x01), "127.0.0.55:30304")
	runDialTest(t, config, []dialTestRound{
		{
			update: func(d *dialScheduler) {
				d.addStatic(node)
