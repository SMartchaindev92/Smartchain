...
// Package p2p implements the Gquantumchain p2p network protocols.
package p2p
...
import (
	...
	"github.com/SMartchaindev92/Smartchain/p2p/discover"
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // Gquantumchain Node Record
