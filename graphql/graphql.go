...
// Package graphql provides a GraphQL interface to Gquantumchain node data.
package graphql
...
// Account represents an Gquantumchain account at a particular block.
type Account struct {
...
// Transaction represents an Gquantumchain transaction.
...
// Block represents an Gquantumchain block.
...
type CallData struct {
	From                 *common.Address // The Gquantumchain address the call is from.
	To                   *common.Address // The Gquantumchain address the call is to.
