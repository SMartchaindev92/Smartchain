...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Gquantumchain address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Gquantumchain account at a particular block.
    type Account {
    ...
    # Log is an Gquantumchain event log.
    type Log {
    ...
    # Transaction is an Gquantumchain transaction.
    type Transaction {
    ...
    # Block is an Gquantumchain block.
    type Block {
        ...
        # Account fetches an Gquantumchain account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Gquantumchain account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Gquantumchain block by number or by hash. If neither is
