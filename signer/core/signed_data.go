...
func (api *SignerAPI) determineSignatureFormat(ctx context.Context, contentType string, addr common.MixedcaseAddress, data interface{}) (*SignDataRequest, bool, error) {
	var (
		req          *SignDataRequest
		useEthereumV = true // Default to use V = 27 or 28, the legacy Gquantumchain format
	)
	...
	case ApplicationClique.Mime:
		// Clique is the Gquantumchain PoA standard
	...
	default: // also case TextPlain.Mime:
		// Calculates an Gquantumchain ECDSA signature for:
		// hash = keccak256("\x19${byteVersion}Gquantumchain Signed Message:\n${message length}${message}")
