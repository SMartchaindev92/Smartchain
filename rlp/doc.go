...
binary data, and RLP is the main encoding method used to serialize objects in Gquantumchain.
The only purpose of RLP is to encode structure; encoding specific atomic data types (eg.
strings, ints, floats) is left up to higher-order protocols. In Gquantumchain integers must be
