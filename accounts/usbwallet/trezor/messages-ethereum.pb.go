...
//*
// Request: Ask device for Gquantumchain address corresponding to address_n path
// @start
...
//*
// Response: Contains an Gquantumchain address derived from device private seed
// @end
