...
import (
	...
	"github.com/SMartchaindev92/Smartchain/tests"
)
...
var makeTest = function(tx, rewind) {
  ...
  var block   = gwc.getBlock(gwc.getTransaction(tx).blockHash);
  var genesis = gwc.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.gwc.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  gwc.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
