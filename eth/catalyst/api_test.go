...
func startEthService(t *testing.T, genesis *core.Genesis, blocks []*types.Block) (*node.Node, *gwc.Gquantumchain) {
	t.Helper()
	...
	ethservice, err := gwc.New(n, ethcfg)
	if err != nil {
		t.Fatal("can't create gwc service:", err)
	}
