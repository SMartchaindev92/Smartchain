...
// ProtocolName is the official short name of the `gwc` protocol used during
// devp2p capability negotiation.
const ProtocolName = "gwc"

// ProtocolVersions are the supported versions of the `gwc` protocol (first
// is primary).
...
// Packet represents a p2p message in the `gwc` protocol.
type Packet interface {
	Name() string // Name returns a string corresponding to the message type.
	Kind() byte   // Kind returns the message type.
}

// StatusPacket is the network packet for the status message for gwc/64 and later.
...
// GetBlockHeadersPacket66 represents a block header query over gwc/66
...
// BlockHeadersPacket represents a block header response over gwc/66.
...
// GetBlockBodiesPacket represents a block body query over gwc/66.
...
// BlockBodiesPacket is the network packet for block content distribution over gwc/66.
...
// BlockBodiesRLPPacket66 is the BlockBodiesRLPPacket over gwc/66
...
// GetNodeDataPacket represents a trie node data query over gwc/66.
...
// NodeDataPacket is the network packet for trie node data distribution over gwc/66.
...
// GetReceiptsPacket represents a block receipts query over gwc/66.
...
// ReceiptsPacket is the network packet for block receipts distribution over gwc/66.
...
// ReceiptsPacket66 is the gwc-66 version of ReceiptsRLPPacket
...
// PooledTransactionsPacket is the network packet for transaction distribution over gwc/66.
...
// PooledTransactionsRLPPacket66 is the gwc/66 form of PooledTransactionsRLPPacket
