...
func (h *handler) syncTransactions(p *gwc.Peer) {
	...
	// The gwc/65 protocol introduces proper transaction announcements, so instead
...
// chain head.
func (cs *chainSyncer) handlePeerEvent(peer *gwc.Peer) bool {
	select {
...
func peerToSyncOp(mode downloader.SyncMode, p *gwc.Peer) *chainSyncOp {
