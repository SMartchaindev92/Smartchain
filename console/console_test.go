...
import (
	...
	"github.com/SMartchaindev92/Smartchain/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Gquantumchain service within
	...
	ethBackend, err := gwc.New(stack, ethConf)
	if err != nil {
		t.Fatalf("failed to register Gquantumchain protocol: %v", err)
	}
