...
import (
	...
	ethproto "github.com/SMartchaindev92/Smartchain/eth/protocols/eth"
...
// Service implements an Gquantumchain netstats reporting daemon that pushes local
...
func (s *Service) login(conn *connWrapper) error {
	...
	var network string
	if info := infos.Protocols["gwc"]; info != nil {
