...
type NodeConfig struct {
	...
	// EthereumEnabled specifies whether the node should run the Gquantumchain protocol.
	EthereumEnabled bool

	// EthereumNetworkID is the network identifier used by the Gquantumchain protocol to
...
// Node represents a Geth Gquantumchain node instance.
type Node struct {
	node *node.Node
}
...
func NewNode(datadir string, config *NodeConfig) (stack *Node, _ error) {
	...
	// Register the Gquantumchain protocol if requested
...
// GetEthereumClient retrieves a client to access the Gquantumchain subsystem.
